...
from app.models import User, Role, Permission, Blog, Comment, Favourite
...
def make_shell_context():
    return dict(app=app, db=db, User=User, Role=Role, Blog=Blog, Comment=Comment, Favourite=Favourite,
